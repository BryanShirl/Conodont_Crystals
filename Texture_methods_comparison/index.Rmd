...
To apply the (conservative) Bonferroni 

```{r}
require(coin)
coin::independence_test(T.index ~ Taxa, 
            data = Data,
            distribution = "exact")
```
Confidence intervals: https://stats.stackexchange.com/questions/368899/is-it-possible-to-calculate-a-confidence-interval-related-to-a-significant-p-val
