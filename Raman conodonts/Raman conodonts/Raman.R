...
OurConodontData = read.csv("C:/Users/Bryan/Desktop/Raman/Data sets/Our raman data.csv")
Specdata = read.csv("C:/Users/Bryan/Desktop/Raman/Data sets/Sample spectra all.csv")
OtherAuthorConoData = read.csv("C:/Users/Bryan/Desktop/Raman/Data sets/All conodont raman data.csv")
ThomasTeethData = read.csv("C:/Users/Bryan/Desktop/Raman/Data sets/Thomas Teeth vs Conos.csv")
...
p1 = ggplot(OurConodontData, aes(y=FWHM, x=Peak,color=Sample.name, shape=Sample.name)) + 
  ...
  ylab("FWHM of v1-(PO4) peak (cm-1)") + 
  xlab("PCMI of v1-(PO4) peak (cm-1)")+
  theme_classic()+
...
pb = ggplot(ThomasTeethData, aes(y=FWHM, x=Peak, color=Name, shape=Location
  ...
  xlab("FWHM of v1-(PO4) peak (cm-1)") + ylab("PCMI of v1-(PO4) peak (cm-1)") +
