...
area1 = ggplot2::ggplot(Data, aes(y=T.index, x=Area, color=Taxa)) + 
  geom_point(size=2) + 
...
area2 = ggplot2::ggplot(Data, aes(y=M.index, x=Area, color=Taxa)) + 
  geom_point(size=2) + 
  ylab(expression("M-index")) + 
  xlab(expression("Area"))+
  theme_classic()+
...
ggarrange(area1,area2, ncol = 2,nrow =1,  labels = c("a", "b"))
```
