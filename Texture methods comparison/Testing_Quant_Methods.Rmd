...
library(ggpubr)
library(knitr)
Data = read.csv("../Texture methods comparison/TextureResults.csv", header = T, sep=';')
```
...
ggarrange(sc1,                                            
          ggarrange(p1,p2 , ncol = 2, labels = c("b", "c"),font.label = list(size = 8, color = "black", face = "bold", family = NULL)),
          ggarrange(p3,p4 , ncol = 2, labels = c("d", "e"),font.label = list(size = 8, color = "black", face = "bold", family = NULL)),
          nrow =3, 
          labels = "a",
          heights = c(2.2,1,1),
