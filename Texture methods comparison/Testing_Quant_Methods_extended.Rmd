...
author: "Bryan Shirley, with edits by Emilia Jarochowska"
date: "2023-11-19"
...
Here we use scatter plots to compare the difference between the M-index and the T Index 
...
It appears that area does have an impact on the TI values, however, the M-index does not have the resolution to decipher the differences between taxa. 
